...
export class Details extends Component{
    ...
    return (  
        <div>
            ...
            <div>
                <div className='INOdetailhead' style={{ backgroundImage: `linear-gradient(120deg,rgba(27,27,27,0.7), rgba(27,27,27,0.5)  ), url(${process.env.REACT_APP_GALLERY_API+this.props.data.image})` }}>
                ...
                <div className='INODetailbox'>
                    ...
                    <div className='INODetailDesc'>
                        <p>
                        {this.props.data.InnovationDesc}
                        </p>
